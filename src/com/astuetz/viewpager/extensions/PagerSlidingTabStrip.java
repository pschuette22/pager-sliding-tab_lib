...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	// private List<CheckBox> tabs = new ArrayList<CheckBox>();
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs,
			int defStyle, boolean textWithIcons) {
...
//				R.styleable.PagerSlidingTabStrip_textAllCaps, textAllCaps);
	...
	private void addIconTab(final int position, int resId) {
		...
		// tab.setButtonDrawable(getContext().getResources().getDrawable(resId));
	...
	private void setTabPosition() {
		...
		for (int i = 0; i < tabsContainer.getChildCount(); i++){
			...
			Log.d("TAG", "Setting Tab Position: " + i + " is selected: " + (selected? "Yes":"No"));
		}

	}

	// private void updateTabsCheckState(int checkedPosition){
	// for(int i = 0; i < tabCount; i++ ){
	// setTabChecked(checkedPosition, checkedPosition == i);
	// }
	// }
	//
	// private void setTabChecked(int position, boolean isChecked){
	// tabs.get(position).setChecked(isChecked);
	// }
